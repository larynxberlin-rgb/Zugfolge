...
BEGIN
  IF EXISTS (
    ...
    WHERE "train_category" = 'regional'
      AND "train_number" BETWEEN 35000 AND 38999
  ) THEN
    RAISE EXCEPTION 'Regionalzugnummern 35000 bis 38999 sind bereits durch Spielerfahrten belegt';
  END IF;
END $$;
...
ALTER TABLE "planning_train_numbers" ADD CONSTRAINT "planning_train_numbers_category_range_check" CHECK (
  ...
  or ("train_category" = 'regional' and "train_number" between 20000 and 34999)
