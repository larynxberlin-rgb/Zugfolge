...
export const vehicleAssets = pgTable(
  "vehicle_assets",
  {
    ...
    odometerMetres: bigint("odometer_metres", { mode: "bigint" }),
    conditionBasisPoints: integer("condition_basis_points"),
    conditionProfile: jsonb("condition_profile"),
    ...
    valuationSpecId: text("valuation_spec_id"),
    valuationBasis: jsonb("valuation_basis"),
