...
async function trustedDeliveryKeys(path) {
  ...
  return Object.freeze({
    "zugfolge-map-deutschland-2026.4": parsed["zugfolge-map-deutschland-2026.4"],
  });
}

test("staged den echten signierten Deutschland-2026.4-V2-Kandidaten im Game fail-closed", {
  ...
  const importId = "infra-deutschland-2026.4-signed-v2-local";
  ...
  assert.deepEqual(
    ...
    },
    {
      ...
      deliveryReleaseId: "infra-deutschland-2026.4",
      signatureStatus: "verified",
      nativeOperationalValidationStatus: "verified",
      operationalStateHash: "deb038434d53963ba6436d4b6811ffc096374ffd1c75887b4945b4a46ea3c788",
