...
const DATABASE_ROLLBACK_PROOF_SCHEMA_37 = "zugfolge-database-rollback-proof/v7";
const DATABASE_ROLLBACK_PROOF_SCHEMA_38 = "zugfolge-database-rollback-proof/v8";
...
export function validateDatabaseRollbackProof(proof, expected = {}) {
  ...
  invariant([DATABASE_ROLLBACK_PROOF_SCHEMA, DATABASE_ROLLBACK_PROOF_SCHEMA_34, DATABASE_ROLLBACK_PROOF_SCHEMA_35, DATABASE_ROLLBACK_PROOF_SCHEMA_36, DATABASE_ROLLBACK_PROOF_SCHEMA_37, DATABASE_ROLLBACK_PROOF_SCHEMA_38].includes(proof.schema), "Datenbank-Rollbackbeleg besitzt ein unbekanntes Schema.");
  const migrationCount = proof.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_38 ? 38 : proof.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_37 ? 37 : proof.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_36 ? 36 : proof.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_35 ? 35 : proof.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_34 ? 34 : 33;
...
export function createDatabaseRollbackProof({
  ...
  const candidate = {
    schema: source?.migrationLedger?.length === 38 ? DATABASE_ROLLBACK_PROOF_SCHEMA_38 : source?.migrationLedger?.length === 37 ? DATABASE_ROLLBACK_PROOF_SCHEMA_37 : source?.migrationLedger?.length === 36 ? DATABASE_ROLLBACK_PROOF_SCHEMA_36 : source?.migrationLedger?.length === 35 ? DATABASE_ROLLBACK_PROOF_SCHEMA_35 : source?.migrationLedger?.length === 34 ? DATABASE_ROLLBACK_PROOF_SCHEMA_34 : DATABASE_ROLLBACK_PROOF_SCHEMA,
    releaseId,
    previousReleaseId,
    rollbackWindow,
    writersQuiesced,
...
function validateDatabaseRollbackBinding(binding, previousReleaseId) {
  ...
  invariant([DATABASE_ROLLBACK_PROOF_SCHEMA, DATABASE_ROLLBACK_PROOF_SCHEMA_34, DATABASE_ROLLBACK_PROOF_SCHEMA_35, DATABASE_ROLLBACK_PROOF_SCHEMA_36, DATABASE_ROLLBACK_PROOF_SCHEMA_37, DATABASE_ROLLBACK_PROOF_SCHEMA_38].includes(binding.schema), "Rollback-Runtime-Tuple bindet kein bekanntes Datenbankbeweis-Schema.");
  ...
  const catalog = databaseAuthoritativeCatalog(binding.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_38 ? 38 : binding.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_37 ? 37 : binding.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_36 ? 36 : binding.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_35 ? 35 : binding.schema === DATABASE_ROLLBACK_PROOF_SCHEMA_34 ? 34 : 33);
