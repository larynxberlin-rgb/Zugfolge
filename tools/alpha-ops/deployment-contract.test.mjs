...
test("Alpha-Compose erzwingt Map- und Welt-Cutover-Gates, Migration, signierten Bootstrap und einen Build ohne impliziten Neubau", async () => {
  ...
  assert.match(schema29QualifierService, /PRODUCTION_SCHEMA29_PRISTINE_GAME_RESTORED_DATABASE_URL:[\s\S]*PRODUCTION_SCHEMA29_PRISTINE_ODOO_RESTORED_DATABASE_URL:[\s\S]*PRODUCTION_SCHEMA29_PRISTINE_ODOO_RESTORED_FILESTORE_PATH:/u);
