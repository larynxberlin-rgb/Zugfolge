  ...
  return {
    ...
    regionalSimulation: {
      ...
      trains: economyLots.map((_lot, index) => ({
        trainRunId: trainRunId(index),
        operator: "public",
        trainNumber: `RE ${index + 1}`,
        category: "regional",
        route: [
          { operatingPoint: "Leipzig Hbf", positionMm: 0, arrivalS: 0, minimumDwellSeconds: 0, departureS: 0 },
          { operatingPoint: "Halle (Saale) Hbf", positionMm: 35_000_000, arrivalS: 1_800, minimumDwellSeconds: 60, departureS: 1_860 },
        ],
      })),
    },
    repeatEveryS: 86_400,
