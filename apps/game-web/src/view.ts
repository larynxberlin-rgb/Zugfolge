...
export function renderProjection(
  ...
  const demoBanner = options.demoMode === true ? '<p class="notice notice--demo" role="status"><strong>Demo · Beispieldaten</strong> Dieser Planungsstand ist nicht serverbestätigt.</p>' : "";
