...
| Eigenes Add-on | `odoo/addons/zugfolge_admin`, Version `19.0.2.0.2` | PolyForm Shield 1.0.0 / Odoo-Manifesteinstellung `Other proprietary` | Zugfolge-Projektion, Weltkatalog, Portal, Freigabe, Signaturgrenze, Feedback |
...
Die Patchversion `19.0.2.0.2` ergänzt Odoo-19-Privileges und eine startbare
