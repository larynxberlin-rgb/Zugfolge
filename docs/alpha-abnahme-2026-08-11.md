...
| M9.7 | read-only Welt-/Simulation-/Queue-/Bridge-/Marktprojektion, Drill-down-Verweise, Datenalter und pseudonymisiertes Feedback; Monitoring- und Feedbackroute produktiv registriert | Browsergerenderte Monitoringansicht; Game-/Commerce-Tests | keine laufende Odoo-19-Instanz und kein realer Alpha-Feedbackbetrieb | in Arbeit |
...
| M12.1 | Traktion, Fahrzeugmiete, Anschlusswartezeit und Ersatzverkehrshilfe; Angebot/Annahme/Ablehnung, Fristen, Cent-Ledger, Postfach, Audit, Events, Welt- und Konfliktprüfungen | Kooperation 7 Tests, Game-Routen und Workspace-E2E; Produktion an Game API gebunden | keine fertige Spieleroberfläche und kein integrierter Zwei-Spieler-Alpha-Fall | in Arbeit |
| M12.2 | Verkauf/Vermietung, unveränderliche Identität und Historie, Zustand/Schäden/Fristen, Bindungen, Reservierung/Übergabe/Rückabwicklung, Doppelbindungs-Schutz | Kooperationstests; Rust-Flotten-Single-Writer einschließlich Transfer/Reversal; Economy-/Runtime-Tests | keine fertige Spieleroberfläche und keine reale Marktlast | in Arbeit |
