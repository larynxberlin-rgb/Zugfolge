...
| Fahrgastmanifest | `PassengerManifestV1` | revisionierte M10-Zuteilung der Fahrgäste eines Zuglaufabschnitts einschließlich Ein-/Ausstieg und verdecktem Fahrberechtigungsstatus; tatsächlicher Bestand nur mit nativen Haltbelegen, sonst Prognose | `personenverkehr.md` 5, `schaffnermodus.md` 3.1 |
